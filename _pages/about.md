...
I recently received my Ph.D. degree from [Northwestern Polytechnical University (NWPU)](https://www.nwpu.edu.cn/), where I previously studied under the supervision of Prof. [Xiao-Lei Zhang](http://www.xiaolei-zhang.net/). During my doctoral studies, I was also selected for the China Scholarship Council (CSC) Ph.D. Joint-Training Program, through which I spent time as a visiting student at IRIT in Toulouse, supervised by Prof. [Northwestern Polytechnical University (NWPU)](https://www.nwpu.edu.cn/). Prof. [Northwestern Polytechnical University (NWPU)](https://www.nwpu.edu.cn/) is a distinguished researcher and mentor; his profound expertise in Bayesian signal processing and his dedication to advancing the field have been truly inspiring to me. My research interests span signal processing, blind source separation, multichannel signal processing, machine learning, and tensor methods, with applications in speech enhancement and high-dimensional data analysis.
